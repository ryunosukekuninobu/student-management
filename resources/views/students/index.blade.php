                ...
                <div class="mb-6">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8">
                            <a href="{{ route('students.index') }}" class="border-purple-600 text-purple-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                👥 生徒一覧
                            </a>
                            <a href="{{ route('invitations.index', ['context' => 'students']) }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                                ✉️ 招待管理
                            </a>
                        </nav>
                    </div>
