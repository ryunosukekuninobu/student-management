...
<head>
    ...
    <title>生徒新規登録 - {{ config('app.name') }}</title>
        ...
        <header class="bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 shadow-lg">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold text-white">生徒新規登録</h1>
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="medical_notes" id="medical_notes" rows="4"
                                    ...
                                    placeholder="アレルギー、持病、服用中の薬など">{{ old('medical_notes') }}</textarea>
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6">
                        ...
                        <div class="p-6">
                            <textarea name="notes" id="notes" rows="4"
                                ...
                                placeholder="管理者用メモ（生徒には表示されません）">{{ old('notes') }}</textarea>
                        </div>
                    </div>
